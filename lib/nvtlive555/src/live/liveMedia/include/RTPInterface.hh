...
public:
  ...
  Boolean sendPacket(unsigned char* packet, unsigned packetSize, int idx_socket=0, int* pByteSent=NULL); //NVT_MODIFIED, Multi-UDP Source //NVT_MODIFIED, WIFI-TEAM
  ...
  int getSocket() {return fGS->socketNum(0);} //wifiteam
