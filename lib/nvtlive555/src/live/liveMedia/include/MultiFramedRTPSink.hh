...
protected:
  ...
  //NVT_MODIFIED
  virtual void NotifyFinishSendPacket(void);
...
public: //NVT_MODIFIED, for multi-thread
	static void sendNext(void* firstArg);
	friend void sendNext(void*);
	static void sendNew(void* firstArg);
	friend void sendNewe(void*);
...
protected: //NVT_MODIFIED
  OutPacketBuffer* fOutBuf;
  unsigned char* fpReplace;
  Boolean        bSkipThisSend;
  u_int32_t fSocketIdx; //NVT_MODIFIED, Multi-UDP Source
  int       fByteSent; //NVT_MODIFIED, Multi-UDP Source
};
