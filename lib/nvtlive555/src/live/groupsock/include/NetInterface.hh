...
#define MAX_CNT_MULTI_UDP 3 //NVT_MODIFIED, Multi-UDP Source
...
public:
  ...
  int socketNum(int idx_socket=0) const ; 
...
private:
  int fSocketNum[MAX_CNT_MULTI_UDP]; //NVT_MODIFIED, Multi-UDP Source
