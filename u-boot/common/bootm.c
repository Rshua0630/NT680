...
#ifdef CONFIG_NT96660 //Auto set CONFIG_SYS_BOOTM_LEN by CORE_INFO.
#include "../board/novatek/evb660/nvt_type.h"
#include "../board/novatek/evb660/CoreInfo.h"
...
#ifdef CONFIG_NT96660 //Auto set CONFIG_SYS_BOOTM_LEN by CORE_INFO.
	CORE_INFO* pCoreInfo = (CORE_INFO*)CODE_INFO_ADDR;
	unc_len = pCoreInfo->uImageAddr - pCoreInfo->LinuxAddr;
#endif
	*load_end = load;
	switch (comp) {
	case IH_COMP_NONE:
