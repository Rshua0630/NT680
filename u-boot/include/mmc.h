...
#define EXT_CSD_HS200_BUS_WIDTH_8	7	/* Card is in 8 bit HS200 mode */
...
struct mmc {
	...
	//uint host_caps;
	u32 boot_capacity; 
	uint data_latch;//to support ddr mode, remove it later when formal release uboot api is decided.
#endif
