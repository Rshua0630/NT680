...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	...
	"memstr=mem=584M@68M mem=98M@2462M\0" \
	"cpus=4\0" \
	"usb_port=0\0" \
	"verify=y\0" \
	"quiet=n\0" \
...
#define CONFIG_BOOTCOMMAND                      "n33002_boot;bootm ${kernel_loadaddr} ${ramdisk_loadaddr}"
...
#define CONFIG_AUTO_SCRIPT          "leonardo_usb_update.scr"
