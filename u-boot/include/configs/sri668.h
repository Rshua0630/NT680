...
#ifndef __CONFIG_SRI668_H__
#define __CONFIG_SRI668_H__
...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	...
	"memstr=mem=760M@68M mem=708M@2364M\0" \
	"mali_core=4\0" \
	"mali_start=0\0" \
	"mali_size=0\0" \
	"mali_share=0x28000000\0" \
	"ump_start=0xA6000000\0" \
	"ump_size=0x1A000000\0" \
	"cpus=4\0" \
	"usb_port=0\0" \
	"verify=y\0" \
	"quiet=n\0" \
...
#define CONFIG_BOOTCOMMAND                      "nvt_boot;bootm ${kernel_loadaddr} ${ramdisk_loadaddr}"
