...
//kwinyee add nand help functions
u32 nand_get_bad_block_size(u32 offset, u32 length);
u32 nand_get_page_size(void);
u32 nand_get_block_size(void);
int nand_write_skip_bad_oob(nand_info_t *nand, size_t offset, size_t *length,
