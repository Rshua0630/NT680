...
#define SENSOR_CAPS_COUNT               0
#define SENSOR_CAPS_MASK                (0)
#define SENSOR_MAP_1                    NA
...
///////FD param
#define IPCAM_FD_FUNC 				ENABLE //is conflict with _FD_FUNC_ and MOVIE_FD_FUNC_
#define MAX_FDNUM     				10     //set face detection max face number
//////DIS param
#if (DEMO_SENSOR6_CCIR == ENABLE)
#define IPCAM_DIS 					DISABLE
#else
#define IPCAM_DIS 					ENABLE //is conflict with MOVIE_DIS
#endif
//////OD param
#define IPCAM_OD_FUNC 				DISABLE


#define IPCAM_YUV_DSP				DISABLE
...
/////AUDIO param
#define IPCAM_AUDIO_IN_FUNC		ENABLE
#define IPCAM_AUDIO_OUT_FUNC 	ENABLE
//==============================================================================
//   NET FUNCTIONS
//==============================================================================
