...
#define SENSOR_MAP_1                    SENSOR_ID_3 //SENSOR_ID_8 --> NVP6124B
...
#define OSD_USE_DOUBLE_BUFFER           ENABLE //use double buffer
     ...
     defined(_Disp_IFDSI_LCD1_NT35510_) || \
     defined(_Disp_IFDSI_LCD1_NT35521_) || \
...
#elif defined(_Disp_IF8B_LCD1_JDI_BU76N33CCH_)
#define LCDMODE                         DISP_LCDMODE_YUV720 //DISP_LCDMODE_YUV720
...
#define MOVIE_BC_MD                     ENABLE  // BC based MD
...
#if defined(_MODEL_DVCAM1_EVB_) || defined(_MODEL_ECOS_EVB_)
