...
#define IPCAM_MAIN_SUB_BUFFER_ONE    4 //(for MAIN-DISP-SUB1, its required buffer count= 1-1-1.)
	...
	//buffer
	#define IPCAM_BUFFER_LEVEL       IPCAM_MAIN_SUB_BUFFER_ONE //IPCAM_BUFFER_ALL
...
#else
	#warning Unknown IPCAM_SENSOR_SET?
	#warning Please assign your "IPCAM_SENSOR_SET" in header "PrjCfg_XXXX.h"
	#error (see above)
#endif /* IPCAM_PRODUCT */
...
#define IPCAM_IPL_ONERAW 				ENABLE //ImagePipe One-Raw Input Mode.
...
#define IPCAM_SUB2_ONE_BUFFER			DISABLE //2st Encoder Path is running in Single-Buffer-Mode
#define IPCAM_SUB2_TRIGGER				IPCAM_TRIGGER_SRC //2st Encoder Path trigger mode
#define IPCAM_SUB2_WAIT					ENABLE //2st Encoder Path will waiting for EncodeFinish
...
#define IPCAM_SUB2_ONE_BUFFER			ENABLE //2st Encoder Path is running in Single-Buffer-Mode
#define IPCAM_SUB2_TRIGGER				IPCAM_TRIGGER_SRC //2st Encoder Path trigger mode
#define IPCAM_SUB2_WAIT					DISABLE //2st Encoder Path will waiting for EncodeFinish
...
#define IPCAM_DIS_FUNC				DISABLE  //for 510
...
#define IPCAM_OD_FUNC                   ENABLE //OD
...
#define MOVIE_FDCNN_FUNC                ENABLE
#define MOVIE_FDCNN_DRAW_VIDEO          ENABLE
#define MOVIE_FDCNN_USE_ODT             ENABLE
...
#define USE_IPC_RESERVED_MEM			ENABLE
