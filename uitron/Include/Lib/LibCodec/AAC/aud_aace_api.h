...
/*---------------------------------------------------------------------------
functionname:AACE_InitConfig
description:  initialize a new encoder configuration.
returns:     EN_AUDIO_ERROR_CODE
---------------------------------------------------------------------------*/
EN_AUDIO_ERROR_CODE AACE_InitConfig(pST_AUDIO_AACENC_CFG pstInputCfg);

/*---------------------------------------------------------------------------
functionname:AACE_EncodeOneFrame
description:  Encode One Frame and feedback information.
returns:     EN_AUDIO_ERROR_CODE
---------------------------------------------------------------------------*/
EN_AUDIO_ERROR_CODE AACE_EncodeOneFrame(pST_AUDIO_AACENC_BUFINFO pstBufInfo, pST_AUDIO_AACENC_RTNINFO pRtnINfo);
