...
---------------------------------------------------------------------------*/
EN_AUDIO_ERROR_CODE AACD_Init(pST_AUDIO_AACDEC_CFG pstInputCfg);

/*---------------------------------------------------------------------------
functionname:AACD_DecodeOneFrame
description:  Decode One Frame and feedback information.
returns:     EN_AUDIO_ERROR_CODE
---------------------------------------------------------------------------*/
EN_AUDIO_ERROR_CODE AACD_DecodeOneFrame(pST_AUDIO_AACD_BUFINFO pstBufInfo, pST_AUDIO_AACD_RTNINFO pRtnINfo);
