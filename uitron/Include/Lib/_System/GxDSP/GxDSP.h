...
/**
    ...
    @return
        ...
        - @b FALSE:  Failed.
*/
extern BOOL GxDSP_Close(DSP_CORE_ID DspCore);
...
/**
    Check if DSP is Opened.

    @param[in] DspCore DSP core ID: #_DSP_CORE_ID.
    @return
        - @b TRUE:  DSP is opened.
        - @b FALSE:  DSP is not opened.
*/
extern BOOL GxDSP_IsOpened(DSP_CORE_ID DspCore);

/**
    Load DSP firmware from FLASH.

	@param[in] DspCore DSP core ID: #_DSP_CORE_ID.
	@param[in] Working buffer: #_MEM_RANGE.
    @return
        - @b TRUE:  Succeed.
        - @b FALSE:  Failed.
*/
extern BOOL GxDSP_LoadFW(DSP_CORE_ID DspCore, PMEM_RANGE pWorkBuf, UINT32 DxTypeMap);
