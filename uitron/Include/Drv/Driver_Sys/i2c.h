...
typedef enum {
	...
	I2C_VD_SIE5,            ///< VD source from SIE channel 5
	I2C_VD_SIE6,            ///< VD source from SIE channel 6
	I2C_VD_SIE7,            ///< VD source from SIE channel 7
	I2C_VD_SIE8,            ///< VD source from SIE channel 8
...
typedef enum {
	...
	I2C_CONFIG_ID_RR_MODE,          ///< HDMI SCDC Read Request Mode select. Please use I2C_RR_MODE as input parameter.
	I2C_CONFIG_ID_RR_SAR,           ///< 7bits HDMI SCDC Slave address. This shall be 0x54 for HDMI SCDC application.
	I2C_CONFIG_ID_RR_CALLBACK,      ///< IST Callback function for Read-Request. Please use DRV_CB as prototype.

	ENUM_DUMMY4WORD(I2C_CONFIG_ID)
} I2C_CONFIG_ID, *PI2C_CONFIG_ID;

/**
    HDMI SCDC Read Request Mode

    This field selects the HDMI Read-Request(RR) Mode.
*/
typedef enum {
	I2C_RR_MODE_READ_UPDATE_FLAG,   ///< Issue Read Update Flag when RR detected
	I2C_RR_MODE_STOP_CONDITION,     ///< Issue Stop Condition when RR detected

	ENUM_DUMMY4WORD(I2C_RR_MODE)
} I2C_RR_MODE;
...
typedef enum {
	...
	I2C_ID_I2C4,      ///< I2C4 Controller ID
	I2C_ID_I2C5,      ///< I2C5 Controller ID
	I2C_ID_I2C6,      ///< I2C6 Controller ID
	I2C_ID_I2C7,      ///< I2C7 Controller ID
...
typedef struct {
	...
	I2C_STS(*transmitSCDC)(void);
	I2C_STS(*getData)(UINT8 *pSCDC_UPDATE_0, UINT8 *pSCDC_UPDATE_1);
...
extern I2C_STS      i2c_transmitSCDC(void);
extern I2C_STS      i2c_getData(UINT8 *pSCDC_UPDATE_0, UINT8 *pSCDC_UPDATE_1);
...
extern I2C_STS      i2c2_transmitSCDC(void);
extern I2C_STS      i2c2_getData(UINT8 *pSCDC_UPDATE_0, UINT8 *pSCDC_UPDATE_1);
...
extern I2C_STS      i2c3_transmitSCDC(void);
extern I2C_STS      i2c3_getData(UINT8 *pSCDC_UPDATE_0, UINT8 *pSCDC_UPDATE_1);
...
extern I2C_STS      i2c4_transmitSCDC(void);
extern I2C_STS      i2c4_getData(UINT8 *pSCDC_UPDATE_0, UINT8 *pSCDC_UPDATE_1);
...
extern I2C_STS      i2c5_transmitSCDC(void);
extern I2C_STS      i2c5_getData(UINT8 *pSCDC_UPDATE_0, UINT8 *pSCDC_UPDATE_1);
