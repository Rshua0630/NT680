...
/**
   ...
   The user can get the EDID information after hdmitx_open() by the api hdmitx_getEdidInfo().
   The driver is opened or not can be checked by the hdmitx_isOpened.
...
/**
    ...
    @param[in] ConfigID     Control function selection ID.
    @param[in] uiConfig     Please reference to the "HDMI_CONFIG_ID" and the application note for the control function parameter details.
...
/**
    ...
    @param[in] ConfigID     Get which Control function configuration selection.
...
/**
    ...
    @param[in] ConfigID     Control function selection ID.
    @param[in] uiConfig     Please reference to the "CEC_CONFIG_ID" and the application note for the control function parameter details.
