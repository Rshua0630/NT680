...
typedef struct {
	UINT32              uiIrSubRWet;    ///< IR weight for subtraction, R channel
	UINT32              uiIrSubGWet;    ///< IR weight for subtraction, G channel
	UINT32              uiIrSubBWet;    ///< IR weight for subtraction, B channel
} SIE_CA_IRSUB_INFO;
