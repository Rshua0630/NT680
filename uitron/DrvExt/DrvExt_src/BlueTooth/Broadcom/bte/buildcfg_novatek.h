...
extern const int  HCILP_BT_WAKE_POLARITY;
extern const int HCILP_HOST_WAKE_POLARITY;      

#define HCILP_BT_WAKE_IDLE_TIMEOUT      300
...
#define WICED_BT_DCT_MAX_DEVICES  5
...
#define BLE_SRVC_ENG_INCLUDED               FALSE
#define SPP_ENABLE                          TRUE
