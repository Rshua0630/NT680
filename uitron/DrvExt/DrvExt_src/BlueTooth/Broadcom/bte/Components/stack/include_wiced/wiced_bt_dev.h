...
//extern wiced_mutex_t bte_global_trace_mutex;
#define WPRINT_BT_APP_INFO(info)   WPRINT_APP_INFO(info)
#endif
...
/**
 * Function         wiced_bt_dev_write_local_addr
 *
 * Write the local device address
 *
 * @param[in]      bd_addr        : Local bd address
 *
 * @param[in]      p_cb            : call back
 *
 * @return          void
 *
 */
void wiced_bt_dev_write_local_addr(BD_ADDR bd_addr, wiced_bt_dev_cmpl_cback_t *p_cb);
/**
...
int wiced_bt_dev_delete_device(BD_ADDR bd_addr);
