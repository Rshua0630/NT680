...
/* Task management
*/
GKI_API extern UINT8   GKI_create_task (TASKPTR, UINT8, INT8 *, UINT16 *, UINT16) _SECTION(".kercfg_text");
...
/* Mutex APIs
*/
GKI_API extern BOOLEAN GKI_mutex_create(GKI_MUTEX *p_mutex) _SECTION(".kercfg_text");
...
GKI_API void gki_active_task(UINT8 task_id);
