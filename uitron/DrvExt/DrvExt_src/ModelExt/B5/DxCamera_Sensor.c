...
static void sen_power_ctrl_imx117cqt(SENSOR_ID id, POW_CTRL_FLAG flag)
{
	...
	case POW_CTRL_TURN_ON:
		//	set dir
		gpio_setDir(P_GPIO_19,GPIO_DIR_OUTPUT); //1.2V
		gpio_setDir(P_GPIO_17,GPIO_DIR_OUTPUT); //1.8V
		gpio_setDir(P_GPIO_18,GPIO_DIR_OUTPUT); //2.8V
...
#if (defined(_CMOS_IMX334M_)) //for JXW
