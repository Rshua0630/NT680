...
UINT32 DrvKey_DetNormalKey(void)
{
	...
	case VOLDET_KEY_LVL_0:
		uiKeyCode |= FLGKEY_DOWN;   //NVTEVT_KEY_NEXT;
		break;
	case VOLDET_KEY_LVL_1:
		uiKeyCode |= FLGKEY_RIGHT;  //NVTEVT_KEY_SELECT; 1. record for preview 2. Menu
		break;
	}
#endif
