...
#if defined(_CPU2_LINUX_)
	.int_id_dst[CC_CORE_CA53_CORE1].Bit.bInt_ID_SPI2            = FALSE,
#else
...
#if defined(_CPU2_LINUX_)
	.int_id_dst[CC_CORE_CA53_CORE1].Bit.bInt_ID_CRYPTO          = FALSE,
#else
...
#endif
	.int_id_dst[CC_CORE_CA53_CORE2].Bit.bInt_ID_SPI             = FALSE,

#if defined(_CPU2_LINUX_)
	.int_id_dst[CC_CORE_CA53_CORE2].Bit.bInt_ID_SPI2            = TRUE,
#else
...
#if defined(_CPU2_LINUX_)
	.int_id_dst[CC_CORE_CA53_CORE2].Bit.bInt_ID_CRYPTO          = TRUE,
#else
