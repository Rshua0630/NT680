...
PIN_GROUP_CONFIG ind_pinmux_cfg_data[] __attribute__((section("modelext_data.pinmux_cfg"))) = {
	...
	{PIN_FUNC_SDIO3,            PIN_SDIO_CFG_8BITS | PIN_SDIO_CFG_2ND_PINMUX},
...
#elif (defined(_SENSOR1_CMOS_MN34120_) && defined(_SENSOR2_CMOS_OFF_) && defined(_SENSOR3_CMOS_OFF_) && defined(_SENSOR4_CMOS_OFF_) && \
     defined(_SENSOR5_CMOS_OFF_) && defined(_SENSOR6_CMOS_OFF_) && defined(_SENSOR7_CMOS_OFF_) && defined(_SENSOR8_CMOS_OFF_))
	{PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_LVDS | PIN_SENSOR_CFG_MCLK|PIN_SENSOR_CFG_LVDS_VDHD},
	{PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
	{PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
...
#elif (defined(_SENSOR1_CMOS_IMX323P_) && defined(_SENSOR2_CMOS_OFF_) && defined(_SENSOR3_CMOS_OFF_) && defined(_SENSOR4_CMOS_OFF_) && \
       defined(_SENSOR5_CMOS_OFF_) && defined(_SENSOR6_CMOS_OFF_) && defined(_SENSOR7_CMOS_OFF_) && defined(_SENSOR8_CMOS_OFF_))
	{PIN_FUNC_SENSOR,           PIN_SENSOR2_CFG_NONE},
	{PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
	{PIN_FUNC_SENSOR3,          PIN_SENSOR_CFG_12BITS | PIN_SENSOR_CFG_MCLK2},
	{PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
	{PIN_FUNC_SENSOR5,          PIN_SENSOR5_CFG_NONE},
	{PIN_FUNC_SENSOR6,          PIN_SENSOR6_CFG_NONE},
	{PIN_FUNC_SENSOR7,          PIN_SENSOR7_CFG_NONE},
...
#elif (defined(_SENSOR1_CMOS_OV7251M_) && defined(_SENSOR2_CMOS_OV7251M_) && defined(_SENSOR3_CMOS_OFF_) && defined(_SENSOR4_CMOS_OFF_) && \
       defined(_SENSOR5_CMOS_OFF_) && defined(_SENSOR6_CMOS_OFF_) && defined(_SENSOR7_CMOS_OFF_) && defined(_SENSOR8_CMOS_OFF_))
	{PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
	{PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_MIPI},
	{PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
	...
	{
		PIN_FUNC_MIPI_LVDS,
		PIN_MIPI_LVDS_CFG_CLK2 | PIN_MIPI_LVDS_CFG_DAT2 |
		PIN_MIPI_LVDS_CFG_CLK6 | PIN_MIPI_LVDS_CFG_DAT6 
	},
#elif (defined(_SENSOR1_CMOS_OV7251M_) && defined(_SENSOR2_CMOS_OFF_) && defined(_SENSOR3_CMOS_OFF_) && defined(_SENSOR4_CMOS_OFF_) && \
       defined(_SENSOR5_CMOS_OFF_) && defined(_SENSOR6_CMOS_OFF_) && defined(_SENSOR7_CMOS_OFF_) && defined(_SENSOR8_CMOS_OFF_))
	{PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
	{PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
	{PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
...
#elif (defined(_SENSOR1_CMOS_AR0521M_) && defined(_SENSOR2_CMOS_OFF_) && defined(_SENSOR3_CMOS_OFF_) && defined(_SENSOR4_CMOS_OFF_) && \
		   defined(_SENSOR5_CMOS_OFF_) && defined(_SENSOR6_CMOS_OFF_) && defined(_SENSOR7_CMOS_OFF_) && defined(_SENSOR8_CMOS_OFF_))
		{PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
		{PIN_FUNC_SENSOR2,			PIN_SENSOR2_CFG_NONE},
		{PIN_FUNC_SENSOR3,			PIN_SENSOR3_CFG_NONE},
...
#elif (defined(_SENSOR1_CMOS_OS05A10M_) && defined(_SENSOR2_CMOS_OFF_) && defined(_SENSOR3_CMOS_OFF_) && defined(_SENSOR4_CMOS_OFF_) && \
       defined(_SENSOR5_CMOS_OFF_) && defined(_SENSOR6_CMOS_OFF_) && defined(_SENSOR7_CMOS_OFF_) && defined(_SENSOR8_CMOS_OFF_))
    {PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,			PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,			PIN_SENSOR3_CFG_NONE},
...
#elif (defined(_SENSOR1_CMOS_OS08A10M_) && defined(_SENSOR2_CMOS_OFF_) && defined(_SENSOR3_CMOS_OFF_) && defined(_SENSOR4_CMOS_OFF_) && \
       defined(_SENSOR5_CMOS_OFF_) && defined(_SENSOR6_CMOS_OFF_) && defined(_SENSOR7_CMOS_OFF_) && defined(_SENSOR8_CMOS_OFF_))
    {PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,			PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,			PIN_SENSOR3_CFG_NONE},
	...
	*/
	{
		...
		PIN_I2C_CFG_CH2 |
#endif
#if (defined(_SENSOR1_CMOS_IMX323P_))
		PIN_I2C_CFG_CH2 |
#endif
...
#if (defined(_SENSOR1_CMOS_OV7251M_))
		PIN_I2C_CFG_CH2 |
#endif

#if (defined(_SENSOR1_CMOS_OV7251M_) && defined(_SENSOR2_CMOS_OV7251M_) )
...
#if (defined(_SENSOR1_CMOS_AR0521M_))
		PIN_I2C_CFG_CH2 |
#endif

#if (defined(_SENSOR1_CMOS_OS05A10M_))
		PIN_I2C_CFG_CH2 |
#endif

#if (defined(_SENSOR1_CMOS_OS08A10M_))
		PIN_I2C_CFG_CH2 |
#endif
...

	{
		...
		PIN_SIF_CFG_CH1 |
#endif
#if (defined(_SENSOR1_CMOS_IMX277CQT_) || defined(_SENSOR1_CMOS_MN34220_))
		PIN_SIF_CFG_CH7 |
#endif
#if (defined(_SENSOR1_CMOS_MN34120_))
		PIN_SIF_CFG_CH7 |
#endif
		0
	},
