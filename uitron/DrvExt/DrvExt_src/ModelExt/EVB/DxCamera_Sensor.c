...
#if (defined(_CMOS_MN34120_))
static SENSOR_INIT_OBJ sensor_get_obj_mn34120(SENSOR_ID id)
{
	...
	init_obj.cmd_info.info.sif.bus_clk = 24000000;//24000000;
	...
	init_obj.sen_2_serial_pin_map[4] = 6;
	init_obj.sen_2_serial_pin_map[5] = 7;
	init_obj.sen_2_serial_pin_map[6] = 9;
	init_obj.sen_2_serial_pin_map[7] = 10;
	return init_obj;
}

static void sen_power_ctrl_mn34120(SENSOR_ID id, POW_CTRL_FLAG flag)
{
	switch (flag) {
...
static SENSOR_INIT_OBJ sensor_get_obj_imx323p(SENSOR_ID id)
{
	...
	init_obj.cmd_info.info.i2c.i2c = SENSOR_I2C2_1ST;
	init_obj.cmd_info.info.i2c.w_addr_sel = SEN_I2C_W_ADDR_DFT;
	init_obj.interface_info.csi.fp_hw_rst = csi_hw_rst_imx323p;
	init_obj.sen_map_if = SENSOR_MAP_IF_DEFAULT;
	init_obj.serial_clane_switch = TRUE;
...
static SENSOR_INIT_OBJ sensor_get_obj_imx291lqr(SENSOR_ID id)
{
	...
	init_obj.cmd_info.info.i2c.i2c = SENSOR_I2C2_1ST;
	init_obj.cmd_info.info.i2c.w_addr_sel = SEN_I2C_W_ADDR_DFT;
	init_obj.cmd_info.info.i2c.s_clk = 50000;
	init_obj.sen_map_if = SENSOR_MAP_IF_DEFAULT;
...
#if (defined(_SENSOR1_CMOS_OV7251M_) && defined(_SENSOR2_CMOS_OV7251M_) && defined(_SENSOR3_CMOS_OFF_) && defined(_SENSOR4_CMOS_OFF_) && \
       defined(_SENSOR5_CMOS_OFF_) && defined(_SENSOR6_CMOS_OFF_) && defined(_SENSOR7_CMOS_OFF_) && defined(_SENSOR8_CMOS_OFF_))
...
#if (defined(_CMOS_IMX334M_)) 

static SENSOR_INIT_OBJ sensor_get_obj_imx334m(SENSOR_ID id)
{
    // set sensor command interface info (Vx1/SIF/I2C/IO/...)
    SENSOR_INIT_OBJ init_obj = {0};
    init_obj.cmd_info.cmd_type = SENSOR_CMD_I2C;
...
static void sen_power_ctrl_imx334m(SENSOR_ID id, POW_CTRL_FLAG flag)
{
...
#if (defined(_CMOS_IMX334M_))
    {"CMOS_IMX334M", sensor_get_drv_tab_imx334m, sensor_get_obj_imx334m, sen_power_ctrl_imx334m, NULL, NULL},
#endif
...
#if (defined(_CMOS_MN34120_))
	{"CMOS_MN34120", sensor_get_drv_tab_mn34120, sensor_get_obj_mn34120, sen_power_ctrl_mn34120, NULL, NULL},
#endif
