...
#define GPIO_LCD_RESET              P_GPIO_26
#define GPIO_LCD_SHDB              P_GPIO_27
...
#define GPIO_TP_RST                 P_GPIO_4//C_GPIO_12//
#define GPIO_TP_INT                 P_GPIO_20//
#define PAD_TP_RST                  PAD_PIN_PGPIO26//PAD_PIN_CGPIO12
#define PAD_TP_INT                  PAD_PIN_PGPIO20
//#endif
...
#define GPIO_KEY_SHUTTER2           P_GPIO_9//P_GPIO_4           // Key Shutter2 (ks2)
#define PAD_KEY_SHUTTER2            PAD_PIN_PGPIO9//PAD_PIN_PGPIO4
...
#define GPIO_KEY_RIGHT              D_GPIO_5           // Key Right (kr)
#define PAD_KEY_RIGHT               PAD_PIN_DGPIO5
#define GPIO_KEY_PLAYBACK           P_GPIO_24//C_GPIO_30           // Key Playback (kmp)
#define PAD_KEY_PLAYBACK            PAD_PIN_PGPIO24//PAD_PIN_CGPIO30
...
#define LED_RED_CTRL                LED_RED_BY_GPIO//LED_RED_DUMMY
#define GPIO_RED_LED                P_GPIO_5//x_GPIO_x  //FPGA
#define PAD_RED_LED                 PAD_PIN_PGPIO5//PAD_PIN_xGPIOx

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_RED_BY_GPIO//LED_RED_DUMMY
#define GPIO_GREEN_LED              P_GPIO_3//x_GPIO_x  //FPGA
#define PAD_GREEN_LED               PAD_PIN_PGPIO3//PAD_PIN_xGPIOx

#define LED_FOCUS_DUMMY             0
#define LED_FOCUS_BY_GPIO           1
#define LED_FOCUS_BY_PWM            2 //use PWM to control LED brightness
#define LED_FOCUS_CTRL              LED_RED_BY_GPIO//LED_RED_DUMMY
#define GPIO_FOCUS_LED              P_GPIO_2//P_GPIO_4//x_GPIO_x  //FPGA
#define PAD_FOCUS_LED               PAD_PIN_PGPIO2//PAD_PIN_PGPIO4//PAD_PIN_xGPIOx
...
//--------------------------------------------------------------------
// WiFi
#define GPIO_WIFI_PWR C_GPIO_13 //WiFi Shut Down
#define GPIO_WL_REG_ON P_GPIO_14
...
// Lens device
//--------------------------------------------------------------------
// ProTruly 6X lens (F06) example on NT9666x
#define GPIO_MOTOR_RESET            P_GPIO_0       // output

#define GPIO_LENS_FOCUS_PI          P_GPIO_6       // input PLS1 pin
#define PAD_LENS_FOCUS_PI           PAD_PIN_PGPIO6

#define GPIO_LENS_ZOOM_PI           P_GPIO_3       // input PLS2 pin
#define PAD_LENS_ZOOM_PI            PAD_PIN_PGPIO3

#define GPIO_LENS_PLS1              GPIO_INT_09    // PLS1 pin -> PWM6
#define GPIO_LENS_PLS2              GPIO_INT_08    // PLS2 pin -> PWM3

#define GPIO_LENS_VD_FZ             P_GPIO_11      // output VD_FZ pin
#define PAD_LENS_VD_FZ              PAD_PIN_PGPIO11

#define GPIO_LENS_ZOOM_PR           P_GPIO_34      // output pin7 zoom PR
#define PAD_LENS_ZOOM_PR            PAD_PIN_PGPIO34

#define GPIO_LENS_FOCUS_PR          P_GPIO_33      // output pin22 focus PR
#define PAD_LENS_FOCUS_PR           PAD_PIN_PGPIO33

#define GPIO_LENS_IR_PR             P_GPIO_4       // output pin24 IR PR
#define PAD_LENS_IR_PR              PAD_PIN_PGPIO4

#define GPIO_LENS_IR_CTLA           P_GPIO_8       // output
#define GPIO_LENS_IR_CTLB           P_GPIO_10      // output
#define PAD_LENS_IR_CTLA            PAD_PIN_PGPIO8
#define PAD_LENS_IR_CTLB            PAD_PIN_PGPIO10
