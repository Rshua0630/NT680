...
GPIO_INIT_OBJ ind_gpio_info_data[] __attribute__((section("modelext_data.gpio_info"))) = {
    ...
    {  GPIO_LCD_SHDB,         GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,  PAD_PIN_NOT_EXIST      },
	{  GPIO_KEY_SHUTTER2,      GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_KEY_SHUTTER2       },
    {  GPIO_KEY_RIGHT,         GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_KEY_RIGHT       },
    {  GPIO_CARD_DETECT ,      GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_CARD_DETECT      },
    {  GPIO_WIFI_PWR,         GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,  PAD_PIN_NOT_EXIST      },

{  GPIO_KEY_PLAYBACK,      GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_KEY_PLAYBACK       },
{  GPIO_GREEN_LED,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,  PAD_GREEN_LED         },
{  GPIO_RED_LED,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,  PAD_RED_LED         },
{  GPIO_FOCUS_LED,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,  PAD_FOCUS_LED         },
...
//{  P_GPIO_28,             GPIO_DIR_INPUT,    PAD_PULLUP,     PAD_PIN_PGPIO26          },
//{  P_GPIO_29,             GPIO_DIR_INPUT,    PAD_PULLUP,     PAD_PIN_PGPIO29          },
#endif
