...
static AE_EXPECT_LUM expect_lum = {
    340, // mov
    340, // photo
    {50, 50, 50, 50, 64, 78, 84, 88, 94, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100}, // mov
    {50, 50, 50, 50, 64, 78, 84, 88, 94, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100}, // photo
...
static AE_OVER_EXPOSURE over_exposure = {
    ...
    815,
    {100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100},
    { 20,  20,  25,  35,  45,  50,  64,  80,  96, 114, 137, 147, 152, 156, 156, 156, 156, 156, 156, 156, 156},
...
AE_PARAM_INFO ae_param_ov7251_evb = {
    AE_PRV_ISO_MIN,
    1000,
    &expect_lum,
    &la_clamp,
...
void ae_get_param_ov7251_evb(UINT32 *param);

void ae_get_param_ov7251_evb(UINT32 *param)
{
	*param = (UINT32) &ae_param_ov7251_evb;
}
