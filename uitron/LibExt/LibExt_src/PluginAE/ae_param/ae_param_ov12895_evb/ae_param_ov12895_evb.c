...
static AE_OVER_EXPOSURE over_exposure = {
    ...
    835,
    {100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100},
    {120, 120, 120, 140, 160, 180, 200, 210, 220, 230, 240, 240, 240, 240, 240, 240, 240, 240, 240, 240, 240},
...
AE_PARAM_INFO ae_param_ov12895_evb = {
    AE_PRV_ISO_MIN,
    1000,
    &expect_lum,
    &la_clamp,
...
void ae_get_param_ov12895_evb(UINT32 *param);

void ae_get_param_ov12895_evb(UINT32 *param)
{
	*param = (UINT32) &ae_param_ov12895_evb;
}
