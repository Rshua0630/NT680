#ifndef _IQ_PARAM_SQNR1_OV7251_ID1_EVB_C
#define _IQ_PARAM_SQNR1_OV7251_ID1_EVB_C

//ISO100
static UINT32 snr_ratio_1x[6] =	 {0x3c,0x0,0x0,0x0,0x0,0x0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_1x[6] =	{0x36, 0x2e, 0x28, 0x2D, 0x30, 0x36};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
...
static UINT32 freq_1x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_1x[4] =	 {0x0,0x0,0x1,0x1};// snr ratio depend on frequency, 4 elements, range = [0, 255]
static UINT32 detail_penalty_1x[6] =	 {0xa,0xa,0x8,0xb,0xb,0xb};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_1x[8] =	 {44, 44, 30, 48, 44, 48, 50, 114};//  sad penalty, 8 elements, range = [0, 15]
...
//ISO200
static UINT32 snr_ratio_2x[6] =	 {0x3c,0x0,0x0,0x0,0x0,0x0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_2x[6] =	{0x2e,0x2e,0x28,0x26,0x23,0x36};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
...
static UINT32 freq_2x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_2x[4] =	 {0x0,0x0,0x1,0x1};// snr ratio depend on frequency, 4 elements, range = [0, 255]
static UINT32 detail_penalty_2x[6] =	 {0xa,0xa,0x8,0xb,0xb,0xb};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_2x[8] =	 {44, 44, 30, 48, 44, 48, 50, 114};//  sad penalty, 8 elements, range = [0, 15]
...
//ISO400
static UINT32 snr_ratio_4x[6] =	 {0x3c,0x0,0x0,0x0,0x0,0x0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_4x[6] =	{0x2e, 0x16, 0x18, 0x1c, 0x20, 0x28};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
...
static UINT32 freq_4x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_4x[4] =	 {0x0,0x0,0x1,0x1};// snr ratio depend on frequency, 4 elements, range = [0, 255]
static UINT32 detail_penalty_4x[6] =	 {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_4x[8] =	 {44, 44, 10, 48, 44, 48, 50, 114};//  sad penalty, 8 elements, range = [0, 15]
...
//ISO800
static UINT32 snr_ratio_8x[6] =	 {0x3c,0x0,0x0,0x0,0x0,0x0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_8x[6] =	{46, 22, 24, 28, 32, 48};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
...
static UINT32 freq_8x[7] =	 {127, 108, 64, 51, 20, 64, 60};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_8x[4] =	 {0x0,0x0,0x1,0x1};// snr ratio depend on frequency, 4 elements, range = [0, 255]
static UINT32 detail_penalty_8x[6] =	 {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_8x[8] =	 {44, 44, 10, 48, 44, 48, 50, 114};//  sad penalty, 8 elements, range = [0, 15]
...
static UINT32 motion_tensor_valmap_8x[4] =	 {12, 51, 0, 25};// tensor remapping, 4 elements, range = [0, 63]
...
//1600
static UINT32 snr_ratio_16x[6] =	 {0x3c, 0x8, 0x6, 0x4, 0x2, 0x1};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_16x[6] =	{0x2e, 0x16, 0x18, 0x1c, 0x20, 0x23};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 luma_gain_16x[8] =	 {0x18, 0x16, 0x14, 0x13, 0x12, 0x11, 0x10, 0x10};// SQUARE strength adjust at luma, 8 elements, range = [0, 255]
static UINT32 freq_16x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_16x[4] =	 {0x0,0x3,0x6,0x6};// snr ratio depend on frequency, 4 elements, range = [0, 255]
static UINT32 detail_penalty_16x[6] =	 {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_16x[8] =	 {0x1e, 0x1e, 0x28, 0x23, 0x1e, 0x23, 0x3c, 0x82};//  sad penalty, 8 elements, range = [0, 15]
...
static UINT32 motion_tensor_valmap_16x[4] =	 {0x4,0x33,0x0,0x19};// tensor remapping, 4 elements, range = [0, 63]
...
{
	0x12,0x2400,0x0,0x3,0x1f0,0x0,0x0,
	{//
...
//ISO3200
static UINT32 snr_ratio_32x[6] =	 {0x3c, 0x7, 0x6, 0x4, 0x2, 0x0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_32x[6] =	{0x28, 0x14, 0x18, 0x1c, 0x17, 0x19};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 luma_gain_32x[8] =	 {0x14, 0x13, 0x12, 0x11, 0x10, 0x10, 0x10, 0x10};// SQUARE strength adjust at luma, 8 elements, range = [0, 255]
static UINT32 freq_32x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_32x[4] =	 {0, 3, 3, 12};// snr ratio depend on frequency, 4 elements, range = [0, 255]
static UINT32 detail_penalty_32x[6] =	 {6, 6, 3, 6, 6, 6};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_32x[8] =	 {0x1e, 0x1e, 0x14, 0x23, 0x1e, 0x23, 0x3c, 0x78};//  sad penalty, 8 elements, range = [0, 15]
...
static UINT32 motion_tensor_valmap_32x[4] =	 {0x4, 0x33, 0x0, 0xa};// tensor remapping, 4 elements, range = [0, 63]
...
{
	0x12,0x2400,0x0,0x3,0x2b2,0x0,0x0,
	{//
...
//ISO6400
static UINT32 snr_ratio_64x[6] =	 {60, 16, 12, 8, 4, 0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_64x[6] =	{0x28, 0x14, 0x18, 0x1c, 0x20, 0x23};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 luma_gain_64x[8] =	 {0x14, 0x13, 0x12, 0x11, 0x11, 0x11, 0x10, 0xf};// SQUARE strength adjust at luma, 8 elements, range = [0, 255]
static UINT32 freq_64x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_64x[4] =	 {0, 4, 4, 12};// snr ratio depend on frequency, 4 elements, range = [0, 255]
static UINT32 detail_penalty_64x[6] =	 {0x5, 0x5, 0x2, 0x5, 0x5, 0x5};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_64x[8] =	 {0x14, 0x14, 0x3c, 0x23, 0x14, 0x19, 0x32, 0x78};//  sad penalty, 8 elements, range = [0, 15]
...
static UINT32 motion_tensor_valmap_64x[4] =	 {0xc, 0x33, 0x0, 0x28};// tensor remapping, 4 elements, range = [0, 63]
...
{
	0x12,0x2400,0x0,0x3,0x27f,0x0,0x0,
	{//
...
//ISO12800
static UINT32 snr_ratio_128x[6] =	 {60, 16, 12, 8, 4, 0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_128x[6] =	{0x32, 0x14, 0x18, 0x1c, 0x20, 0x23};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 luma_gain_128x[8] =	 {0x14, 0x13, 0x12, 0x11, 0x10, 0x10, 0x10, 0xf};// SQUARE strength adjust at luma, 8 elements, range = [0, 255]
static UINT32 freq_128x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_128x[4] =	 {0, 4, 4, 12};// snr ratio depend on frequency, 4 elements, range = [0, 255]
static UINT32 detail_penalty_128x[6] =	 {0x5, 0x5, 0x3, 0x5, 0x5, 0x5};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_128x[8] =	 {0x1e, 0x1e, 0x1e, 0x23, 0x1e, 0x23, 0x50, 0xa0};//  sad penalty, 8 elements, range = [0, 15]
...
static UINT32 motion_tensor_valmap_128x[4] =	 {0xc, 0x33, 0x0, 0x28};// tensor remapping, 4 elements, range = [0, 63]
static UINT32 motion_map_128x[5] =	 {0x2c,0x23,0x19,0xc,0x8};// decide number of full search patches, 5 elements, range = [0, 63]

static IME_HAL_3DNR_LUMA_PARAM sq_l_info_128x =
{
	0x14,0x2400,0x0,0x3,0x2b2,0x0,0x0,
	{//
...
static UINT32 chroma_info_mix_th_128x[4] =	 {0x32,0x3,0x32,0x3};// luma threshold to mix the motion detect value, and chroma threshold to mix the motion detect value, 4 elements
