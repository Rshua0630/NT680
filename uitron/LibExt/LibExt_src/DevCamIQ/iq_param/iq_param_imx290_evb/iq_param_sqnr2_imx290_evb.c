#ifndef _IQ_PARAM_SQNR2_IMX290_EVB_C
#define _IQ_PARAM_SQNR2_IMX290_EVB_C

//ISO100
static UINT32 snr_ratio_1x[6] =	 {0x3c,0x0,0x0,0x0,0x0,0x0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_1x[6] = {0x36, 0x16, 0x18, 0x1c, 0x30, 0x3c};
static UINT32 luma_gain_1x[8] = {0x20, 0x20, 0x18, 0x10, 0x10, 0x10, 0x10, 0x10};
...
static UINT32 detail_penalty_1x[6] = {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};
static UINT32 sad_penalty_1x[8] = {0x2c, 0x2c, 0x1e, 0x30, 0x2c, 0x30, 0x32, 0x8c};
...
static UINT32 motion_tensor_valmap_1x[4] = {0x8, 0x33, 0x0, 0xa};
...
{
    0xa, 0x2400, 0x0, 0x3, 0x1f0, 0x0, 0x0,
	{//
...
//ISO200
static UINT32 snr_ratio_2x[6] = {0x3c, 0xc, 0x9, 0x6, 0x4, 0x0};
static UINT32 tnr_ratio_2x[6] = {0x2e, 0x16, 0x18, 0x1c, 0x30, 0x3c};
static UINT32 luma_gain_2x[8] = {0x20, 0x20, 0x18, 0x10, 0x10, 0x10, 0x10, 0x10};
static UINT32 freq_2x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_2x[4] = {0x0, 0x3, 0x6, 0xc};
static UINT32 detail_penalty_2x[6] = {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};
static UINT32 sad_penalty_2x[8] = {0x2c, 0x2c, 0x1e, 0x30, 0x2c, 0x30, 0x32, 0x78};
...
static UINT32 motion_tensor_valmap_2x[4] = {0x8, 0x33, 0x0, 0xa};
...
{
    0x14, 0x2400, 0x0, 0x3, 0x2bc, 0x0, 0x0,
	{//
...
//ISO400
static UINT32 snr_ratio_4x[6] = {0x3c, 0xc, 0x9, 0x6, 0x4, 0x0};
static UINT32 tnr_ratio_4x[6] = {0x2e, 0x16, 0x18, 0x1c, 0x20, 0x3c};
static UINT32 luma_gain_4x[8] = {0x20, 0x20, 0x18, 0x10, 0x10, 0x10, 0x10, 0x10};
static UINT32 freq_4x[7] =	 {0x7f,0x6c,0x40,0x33,0x14,0x40,0x3c};// set diff ratio in diff freq, 7 elements, range = [0, 127]
static UINT32 snr_freq_4x[4] = {0x0, 0x3, 0x6, 0xc};
static UINT32 detail_penalty_4x[6] =	 {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_4x[8] = {0x2c, 0x2c, 0x1e, 0x30, 0x2c, 0x30, 0x32, 0x72};
...
static UINT32 motion_tensor_valmap_4x[4] = {0x8, 0x33, 0x0, 0xc};
...
//ISO800
static UINT32 snr_ratio_8x[6] = {0x3c, 0xc, 0x9, 0x6, 0x4, 0x0};
static UINT32 tnr_ratio_8x[6] = {0x2e, 0x16, 0x18, 0x1c, 0x20, 0x34};
static UINT32 luma_gain_8x[8] = {0x1a, 0x1a, 0x14, 0x10, 0x10, 0x10, 0x10, 0x10};
static UINT32 freq_8x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_8x[4] = {0x0, 0x3, 0x6, 0xc};
static UINT32 detail_penalty_8x[6] =	 {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_8x[8] = {0x2c, 0x2c, 0x28, 0x30, 0x2c, 0x30, 0x32, 0x72};
...
static UINT32 motion_tensor_valmap_8x[4] = {0xa, 0x33, 0x0, 0x14};
...
{
    0x18, 0x2400, 0x0, 0x3, 0x2bc, 0x0, 0x0,
	{//
...
//1600
static UINT32 snr_ratio_16x[6] = {0x3c, 0xc, 0x9, 0x6, 0x4, 0x0};
static UINT32 tnr_ratio_16x[6] = {0x2e, 0x23, 0x23, 0x26, 0x23, 0x32};
...
static UINT32 snr_freq_16x[4] = {0x0, 0x3, 0x6, 0xc};
static UINT32 detail_penalty_16x[6] = {0x6, 0x6, 0x3, 0x6, 0x6, 0x6};
static UINT32 sad_penalty_16x[8] = {0x2c, 0x2c, 0x14, 0x30, 0x2c, 0x30, 0x3c, 0x72};
...
static UINT32 motion_tensor_valmap_16x[4] = {0x8, 0x33, 0x0, 0x14};
...
{
    0x1c, 0x2400, 0x0, 0x3, 0x2bc, 0x0, 0x0,
	{//
