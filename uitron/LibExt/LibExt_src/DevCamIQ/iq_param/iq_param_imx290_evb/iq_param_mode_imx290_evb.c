...
static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    ...
    iq_param_imx290_evb_table2_init,						////IQS_PARAM_TABLE2
	NULL
...
static iq_param_table mode2tbl[SENSOR_MODE_Num] ={
	...
	IQS_PARAM_TABLE_2, //SENSOR_MODE_3
	IQS_PARAM_TABLE_2, //SENSOR_MODE_4
	IQS_PARAM_TABLE_2, //SENSOR_MODE_5
	IQS_PARAM_TABLE_2, //SENSOR_MODE_6
