#ifndef _IQ_PARAM_SQNR1_IMX291_EVB_C
#define _IQ_PARAM_SQNR1_IMX291_EVB_C
...
static UINT32 luma_gain_8x[8] =	 {16, 14, 13, 12, 12, 11, 11, 10};// SQUARE strength adjust at luma, 8 elements, range = [0, 255]
...
//1600
static UINT32 snr_ratio_16x[6] =	 {0x3c,0x0,0x0,0x0,0x0,0x0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_16x[6] =	{0x2e,0x23,0x23,0x26,0x23,0x28};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
...
static UINT32 sad_penalty_16x[8] =	 {44, 44, 20, 48, 44, 48, 60, 114};//  sad penalty, 8 elements, range = [0, 15]
...
static UINT32 motion_tensor_valmap_16x[4] =	 {0xc,0x33,0x0,0x14};// tensor remapping, 4 elements, range = [0, 63]
...
//ISO3200
static UINT32 snr_ratio_32x[6] =	 {60, 12, 9, 6, 4, 0};// set SNR ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 tnr_ratio_32x[6] =	{60, 20, 24, 28, 38, 40};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
...
static UINT32 sad_penalty_32x[8] =	 {40, 40, 30, 44, 40, 44, 50, 120};//  sad penalty, 8 elements, range = [0, 15]
...
static UINT32 motion_tensor_valmap_32x[4] =	 {12, 51, 0, 20};// tensor remapping, 4 elements, range = [0, 63]
...
{
	0x20,0x2400,0x0,0x3,0x320,0x0,0x0,
	{//
...
static UINT32 chroma_info_mix_th_32x[4] =	 {0x46,0x3,0x46,0x3};// luma threshold to mix the motion detect value, and chroma threshold to mix the motion detect value, 4 elements
...
static UINT32 tnr_ratio_64x[6] =	{0x3c, 0x23, 0x1e, 0x1c, 0x1d, 0x24};// set tnr ratio in diff full search patch, 6 elements, range = [0, 127]
static UINT32 luma_gain_64x[8] =	 {14, 18, 22, 20, 19, 17, 16, 15};// SQUARE strength adjust at luma, 8 elements, range = [0, 255]
...
static UINT32 detail_penalty_64x[6] =	 {6, 6, 3, 6, 6, 6};//  detail penalty, 6 elements, range = [0, 15]
static UINT32 sad_penalty_64x[8] =	 {30, 30, 70, 35, 30, 35, 70, 140};//  sad penalty, 8 elements, range = [0, 15]
...
static UINT32 motion_tensor_valmap_64x[4] =	 {12, 51, 0, 18};// tensor remapping, 4 elements, range = [0, 63]
static UINT32 motion_map_64x[5] =	 {0x32,0x2c,0x23,0x16,0xc};// decide number of full search patches, 5 elements, range = [0, 63]

static IME_HAL_3DNR_LUMA_PARAM sq_l_info_64x =
{
	0x24,0x2400,0x0,0x3,0x320,0x0,0x0,
	{//
...
static UINT32 chroma_info_mix_th_64x[4] =	 {0x46,0x3,0x46,0x3};// luma threshold to mix the motion detect value, and chroma threshold to mix the motion detect value, 4 elements
...
//ISO204800
static UINT32 snr_ratio_2048x[6] = {0x32, 0x2, 0x1, 0x1, 0x1, 0x0};
static UINT32 tnr_ratio_2048x[6] = {0x3c, 0x19, 0x19, 0x1c, 0x1d, 0x3f};
static UINT32 luma_gain_2048x[8] = {0x18, 0x18, 0x16, 0x15, 0x14, 0x13, 0x12, 0x10};
static UINT32 freq_2048x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x40};
static UINT32 snr_freq_2048x[4] = {0x1, 0x4, 0x4, 0xc};
static UINT32 detail_penalty_2048x[6] = {0x5, 0x5, 0x2, 0x5, 0x5, 0x5};
static UINT32 sad_penalty_2048x[8] = {0x28, 0x28, 0x46, 0x2d, 0x28, 0x2d, 0x50, 0xa0};
static UINT32 periodic_sad_similar_2048x[4] =	 {0x2,0x0,0x0,0x0};//  Periodic sad similar, 4 elements
static UINT32 candiate_pos_x_2048x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_2048x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_2048x[4] = {0x8, 0x30, 0x0, 0x5};
...
static UINT32 chroma_info_luma_gain_2048x[8] = {0x40, 0x38, 0x30, 0x20, 0x10, 0x10, 0x10, 0x10};
static UINT32 chroma_info_motion_ctrl_2048x[16] = {0x9d, 0x87, 0x72, 0x5d, 0x52, 0x4c, 0x47, 0x44, 0x42, 0x40, 0x3f, 0x3e, 0x3d, 0x3c, 0x3b, 0x3a};
