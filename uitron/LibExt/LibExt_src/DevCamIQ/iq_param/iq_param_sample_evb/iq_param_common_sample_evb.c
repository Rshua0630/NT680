...
//**  DCE-2DLUT
//////////////////////
_2DLUT_PARAM dc_2d_param_sample_evb[4] =
{
	{
		0,
		{0, 0, 0, 0},
...
UINT32 dc_2dlut00_sample_evb[65*65] =
{
	0
};

UINT32 dc_2dlut01_sample_evb[65*65] =
{
	0
};

UINT32 dc_2dlut02_sample_evb[65*65] =
{
	0
};

UINT32 dc_2dlut03_sample_evb[65*65] =
{
	0
};
...
//**  DCE-IPL STRIPE INFO
//////////////////////
IPL_STRP_INFO strp_info_sample_evb[4] =
{
	{
...
{
    CC_3_8, toIdentity, CC_PRE_GAMMA, CC_SEL_MAX, (UINT32)color_high_sample_evb.IQS_CC, (UINT32)fs_tab_sample_evb, (UINT32)fd_tab_sample_evb
};
