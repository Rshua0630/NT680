#ifndef _IQ_PARAM_SQNR1_IMX317_EVB_C
#define _IQ_PARAM_SQNR1_IMX317_EVB_C

//ISO100
static UINT32 snr_ratio_1x[6] = {0x3c, 0x0, 0x0, 0x0, 0x0, 0x0};
static UINT32 tnr_ratio_1x[6] = {0x36, 0x2e, 0x28, 0x2d, 0x30, 0x36};
static UINT32 luma_gain_1x[8] = {0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10};
static UINT32 freq_1x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_1x[4] = {0x0, 0x0, 0x1, 0x1};
static UINT32 detail_penalty_1x[6] = {0xa, 0xa, 0x8, 0xb, 0xb, 0xb};
static UINT32 sad_penalty_1x[8] = {0x2c, 0x2c, 0x1e, 0x30, 0x2c, 0x30, 0x32, 0x72};
static UINT32 periodic_sad_similar_1x[4] = {0x2, 0x0, 0x0, 0x0};
static UINT32 candiate_pos_x_1x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_1x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_1x[4] = {0x0, 0x33, 0x0, 0x8};
static UINT32 motion_map_1x[5] = {0x2c, 0x23, 0x19, 0xc, 0x8};
...
static UINT32 chroma_info_luma_gain_1x[8] = {0x10, 0x10, 0x10, 0x10, 0x20, 0x30, 0x38, 0x40};
static UINT32 chroma_info_motion_ctrl_1x[16] = {0x6b, 0x5f, 0x55, 0x4b, 0x41, 0x37, 0x32, 0x2d, 0x28, 0x23, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e};
static UINT32 chroma_info_map2d_weight_1x[4] = {0x0, 0x0, 0x80, 0x8};
static UINT32 chroma_info_map3D_weight_1x[4] = {0x0, 0x40, 0x80, 0xf8};
static UINT32 chroma_info_mix_th_1x[4] = {0x46, 0x3, 0x46, 0x3};
static UINT32 chroma_info_level_map_1x[16] = {0x0, 0x3, 0x7, 0xc, 0x11, 0x18, 0x20, 0x29, 0x34, 0x42, 0x51, 0x64, 0x7a, 0x95, 0xb4, 0xd9};
...
//ISO200
static UINT32 snr_ratio_2x[6] = {0x3c, 0x0, 0x0, 0x0, 0x0, 0x0};
static UINT32 tnr_ratio_2x[6] = {0x2e, 0x2e, 0x28, 0x26, 0x23, 0x36};
static UINT32 luma_gain_2x[8] = {0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10};
static UINT32 freq_2x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_2x[4] = {0x0, 0x0, 0x1, 0x1};
static UINT32 detail_penalty_2x[6] = {0xa, 0xa, 0x8, 0xb, 0xb, 0xb};
static UINT32 sad_penalty_2x[8] = {0x2c, 0x2c, 0x1e, 0x30, 0x2c, 0x30, 0x32, 0x72};
static UINT32 periodic_sad_similar_2x[4] = {0x2, 0x0, 0x0, 0x0};
static UINT32 candiate_pos_x_2x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_2x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_2x[4] = {0x0, 0x33, 0x0, 0xa};
static UINT32 motion_map_2x[5] = {0x2c, 0x23, 0x19, 0xc, 0x8};
...
static UINT32 chroma_info_luma_gain_2x[8] = {0x10, 0x10, 0x10, 0x10, 0x20, 0x30, 0x38, 0x40};
static UINT32 chroma_info_motion_ctrl_2x[16] = {0x6b, 0x5f, 0x55, 0x4b, 0x41, 0x37, 0x32, 0x2d, 0x28, 0x23, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e};
static UINT32 chroma_info_map2d_weight_2x[4] = {0x0, 0x0, 0x80, 0x8};
static UINT32 chroma_info_map3D_weight_2x[4] = {0x0, 0x40, 0x80, 0xf8};
static UINT32 chroma_info_mix_th_2x[4] = {0x46, 0x3, 0x46, 0x3};
static UINT32 chroma_info_level_map_2x[16] = {0x0, 0x3, 0x7, 0xc, 0x11, 0x18, 0x20, 0x29, 0x34, 0x42, 0x51, 0x64, 0x7a, 0x95, 0xb4, 0xd9};
...
//ISO400
static UINT32 snr_ratio_4x[6] = {0x3c, 0x0, 0x0, 0x0, 0x0, 0x0};
static UINT32 tnr_ratio_4x[6] = {0x2e, 0x16, 0x18, 0x1c, 0x20, 0x28};
static UINT32 luma_gain_4x[8] = {0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10};
static UINT32 freq_4x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_4x[4] = {0x0, 0x0, 0x1, 0x1};
static UINT32 detail_penalty_4x[6] = {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};
static UINT32 sad_penalty_4x[8] = {0x2c, 0x2c, 0xa, 0x30, 0x2c, 0x30, 0x32, 0x72};
static UINT32 periodic_sad_similar_4x[4] = {0x2, 0x0, 0x0, 0x0};
static UINT32 candiate_pos_x_4x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_4x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_4x[4] = {0x0, 0x33, 0x0, 0xc};
static UINT32 motion_map_4x[5] = {0x2c, 0x23, 0x19, 0xc, 0x8};
...
static UINT32 chroma_info_luma_gain_4x[8] = {0x10, 0x10, 0x10, 0x10, 0x20, 0x30, 0x38, 0x40};
static UINT32 chroma_info_motion_ctrl_4x[16] = {0x6b, 0x5f, 0x55, 0x4b, 0x41, 0x37, 0x32, 0x2d, 0x28, 0x23, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e};
static UINT32 chroma_info_map2d_weight_4x[4] = {0x0, 0x0, 0x80, 0x8};
static UINT32 chroma_info_map3D_weight_4x[4] = {0x0, 0x40, 0x80, 0xf8};
static UINT32 chroma_info_mix_th_4x[4] = {0x41, 0x3, 0x41, 0x3};
static UINT32 chroma_info_level_map_4x[16] = {0x0, 0x3, 0x7, 0xc, 0x11, 0x18, 0x20, 0x29, 0x34, 0x42, 0x51, 0x64, 0x7a, 0x95, 0xb4, 0xd9};
...
//ISO800
static UINT32 snr_ratio_8x[6] = {0x3c, 0x0, 0x0, 0x0, 0x0, 0x0};
static UINT32 tnr_ratio_8x[6] = {0x2e, 0x16, 0x18, 0x1c, 0x20, 0x30};
static UINT32 luma_gain_8x[8] = {0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10};
static UINT32 freq_8x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_8x[4] = {0x0, 0x0, 0x1, 0x1};
static UINT32 detail_penalty_8x[6] = {0x7, 0x7, 0x5, 0x7, 0x7, 0x7};
static UINT32 sad_penalty_8x[8] = {0x2c, 0x2c, 0xa, 0x30, 0x2c, 0x30, 0x32, 0x72};
static UINT32 periodic_sad_similar_8x[4] = {0x2, 0x0, 0x0, 0x0};
static UINT32 candiate_pos_x_8x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_8x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_8x[4] = {0xc, 0x33, 0x0, 0x19};
static UINT32 motion_map_8x[5] = {0x2c, 0x23, 0x19, 0xc, 0x8};
static IME_HAL_3DNR_LUMA_PARAM sq_l_info_8x =
{
    0x14, 0x2400, 0x0, 0x3, 0x1f0, 0x0, 0x0,
    {// RecurviseSearch
...
static UINT32 chroma_info_luma_gain_8x[8] = {0x10, 0x10, 0x10, 0x10, 0x20, 0x30, 0x38, 0x40};
static UINT32 chroma_info_motion_ctrl_8x[16] = {0x6b, 0x5f, 0x55, 0x4b, 0x41, 0x37, 0x32, 0x2d, 0x28, 0x23, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e};
static UINT32 chroma_info_map2d_weight_8x[4] = {0x0, 0x0, 0x80, 0x8};
static UINT32 chroma_info_map3D_weight_8x[4] = {0x0, 0x40, 0x80, 0xf8};
static UINT32 chroma_info_mix_th_8x[4] = {0x3c, 0x3, 0x3c, 0x3};
static UINT32 chroma_info_level_map_8x[16] = {0x0, 0x3, 0x7, 0xc, 0x11, 0x18, 0x20, 0x29, 0x34, 0x42, 0x51, 0x64, 0x7a, 0x95, 0xb4, 0xd9};
...
//ISO1600
static UINT32 snr_ratio_16x[6] = {0x3c, 0x8, 0x6, 0x4, 0x2, 0x1};
static UINT32 tnr_ratio_16x[6] = {0x2e, 0x16, 0x18, 0x1c, 0x20, 0x23};
static UINT32 luma_gain_16x[8] = {0x18, 0x16, 0x14, 0x13, 0x12, 0x11, 0x10, 0x10};
static UINT32 freq_16x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_16x[4] = {0x0, 0x3, 0x6, 0x6};
static UINT32 detail_penalty_16x[6] = {0x7, 0x7, 0x4, 0x7, 0x7, 0x7};
static UINT32 sad_penalty_16x[8] = {0x1e, 0x1e, 0x14, 0x23, 0x1e, 0x23, 0x3c, 0x82};
static UINT32 periodic_sad_similar_16x[4] = {0x2, 0x0, 0x0, 0x0};
static UINT32 candiate_pos_x_16x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_16x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_16x[4] = {0x4, 0x33, 0x0, 0x19};
static UINT32 motion_map_16x[5] = {0x2c, 0x23, 0x19, 0xc, 0x8};
static IME_HAL_3DNR_LUMA_PARAM sq_l_info_16x =
{
    0x1a, 0x2400, 0x0, 0x3, 0x1f0, 0x0, 0x0,
    {// RecurviseSearch
...
static UINT32 chroma_info_luma_gain_16x[8] = {0x10, 0x10, 0x10, 0x10, 0x20, 0x30, 0x38, 0x40};
static UINT32 chroma_info_motion_ctrl_16x[16] = {0x6b, 0x5f, 0x55, 0x4b, 0x41, 0x37, 0x32, 0x2d, 0x28, 0x23, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e};
static UINT32 chroma_info_map2d_weight_16x[4] = {0x0, 0x0, 0x80, 0x8};
static UINT32 chroma_info_map3D_weight_16x[4] = {0x0, 0x40, 0x80, 0xf8};
static UINT32 chroma_info_mix_th_16x[4] = {0x37, 0x3, 0x37, 0x3};
static UINT32 chroma_info_level_map_16x[16] = {0x0, 0x3, 0x7, 0xc, 0x11, 0x18, 0x20, 0x29, 0x34, 0x42, 0x51, 0x64, 0x7a, 0x95, 0xb4, 0xd9};
...
//ISO3200
static UINT32 snr_ratio_32x[6] = {0x3c, 0xa, 0x8, 0x6, 0x3, 0x0};
static UINT32 tnr_ratio_32x[6] = {0x28, 0x14, 0x18, 0x1c, 0x20, 0x23};
static UINT32 luma_gain_32x[8] = {0x14, 0x13, 0x12, 0x11, 0x10, 0x10, 0x10, 0x10};
static UINT32 freq_32x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_32x[4] = {0x0, 0x3, 0x3, 0xc};
static UINT32 detail_penalty_32x[6] = {0x6, 0x6, 0x3, 0x6, 0x6, 0x6};
static UINT32 sad_penalty_32x[8] = {0x1e, 0x1e, 0x14, 0x1e, 0x1e, 0x1e, 0x25, 0x4a};
static UINT32 periodic_sad_similar_32x[4] = {0x2, 0x0, 0x0, 0x0};
static UINT32 candiate_pos_x_32x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_32x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_32x[4] = {0x4, 0x33, 0x0, 0xa};
static UINT32 motion_map_32x[5] = {0x2c, 0x23, 0x19, 0xc, 0x8};
static IME_HAL_3DNR_LUMA_PARAM sq_l_info_32x =
{
    0x20, 0x2400, 0x0, 0x3, 0x2b2, 0x0, 0x0,
    {// RecurviseSearch
...
static UINT32 chroma_info_luma_gain_32x[8] = {0x10, 0x10, 0x10, 0x10, 0x20, 0x30, 0x38, 0x40};
static UINT32 chroma_info_motion_ctrl_32x[16] = {0x6b, 0x5f, 0x55, 0x4b, 0x41, 0x37, 0x32, 0x2d, 0x28, 0x23, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e};
static UINT32 chroma_info_map2d_weight_32x[4] = {0x0, 0x0, 0x80, 0x8};
static UINT32 chroma_info_map3D_weight_32x[4] = {0x0, 0x40, 0x80, 0xf8};
static UINT32 chroma_info_mix_th_32x[4] = {0x32, 0x3, 0x32, 0x3};
static UINT32 chroma_info_level_map_32x[16] = {0x0, 0x3, 0x7, 0xc, 0x11, 0x18, 0x20, 0x29, 0x34, 0x42, 0x51, 0x64, 0x7a, 0x95, 0xb4, 0xd9};
...
//ISO6400
static UINT32 snr_ratio_64x[6] = {0x3c, 0x10, 0xc, 0x8, 0x4, 0x0};
static UINT32 tnr_ratio_64x[6] = {0x28, 0x14, 0x18, 0x1c, 0x20, 0x23};
static UINT32 luma_gain_64x[8] = {0x14, 0x13, 0x12, 0x11, 0x10, 0x10, 0x10, 0xf};
static UINT32 freq_64x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_64x[4] = {0x0, 0x4, 0x4, 0xc};
static UINT32 detail_penalty_64x[6] = {0x5, 0x5, 0x2, 0x5, 0x5, 0x5};
static UINT32 sad_penalty_64x[8] = {0x14, 0x14, 0x3c, 0x23, 0x14, 0x19, 0x32, 0x78};
static UINT32 periodic_sad_similar_64x[4] = {0x2, 0x0, 0x0, 0x0};
static UINT32 candiate_pos_x_64x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_64x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_64x[4] = {0xc, 0x33, 0x0, 0x1e};
static UINT32 motion_map_64x[5] = {0x2c, 0x23, 0x19, 0xc, 0x8};
static IME_HAL_3DNR_LUMA_PARAM sq_l_info_64x =
{
    0x24, 0x2400, 0x0, 0x3, 0x2b2, 0x0, 0x0,
    {// RecurviseSearch
...
static UINT32 chroma_info_luma_gain_64x[8] = {0x10, 0x10, 0x10, 0x10, 0x20, 0x30, 0x38, 0x40};
static UINT32 chroma_info_motion_ctrl_64x[16] = {0x6b, 0x5f, 0x55, 0x4b, 0x41, 0x37, 0x32, 0x2d, 0x28, 0x23, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e};
static UINT32 chroma_info_map2d_weight_64x[4] = {0x0, 0x0, 0x80, 0x8};
static UINT32 chroma_info_map3D_weight_64x[4] = {0x0, 0x40, 0x80, 0xf8};
static UINT32 chroma_info_mix_th_64x[4] = {0x32, 0x3, 0x32, 0x3};
static UINT32 chroma_info_level_map_64x[16] = {0x0, 0x3, 0x7, 0xc, 0x11, 0x18, 0x20, 0x29, 0x34, 0x42, 0x51, 0x64, 0x7a, 0x95, 0xb4, 0xd9};
...
//ISO12800
static UINT32 snr_ratio_128x[6] = {0x3c, 0x10, 0xc, 0x8, 0x4, 0x0};
static UINT32 tnr_ratio_128x[6] = {0x32, 0x14, 0x18, 0x1c, 0x20, 0x23};
static UINT32 luma_gain_128x[8] = {0x14, 0x13, 0x12, 0x11, 0x10, 0x10, 0x10, 0xf};
static UINT32 freq_128x[7] = {0x7f, 0x6c, 0x40, 0x33, 0x14, 0x40, 0x3c};
static UINT32 snr_freq_128x[4] = {0x0, 0x4, 0x4, 0xc};
static UINT32 detail_penalty_128x[6] = {0x5, 0x5, 0x3, 0x5, 0x5, 0x5};
static UINT32 sad_penalty_128x[8] = {0x1e, 0x1e, 0x1e, 0x23, 0x1e, 0x23, 0x50, 0xa0};
static UINT32 periodic_sad_similar_128x[4] = {0x2, 0x0, 0x0, 0x0};
static UINT32 candiate_pos_x_128x[7] = {0x5, 0x1, 0x0, 0x6, 0x2, 0x5, 0x1};
static UINT32 candiate_pos_y_128x[7] = {0x5, 0x5, 0x2, 0x2, 0x2, 0x5, 0x5};
static UINT32 motion_tensor_valmap_128x[4] = {0xc, 0x33, 0x0, 0x28};
static UINT32 motion_map_128x[5] = {0x2c, 0x23, 0x19, 0xc, 0x8};
...
static UINT32 chroma_info_luma_gain_128x[8] = {0x10, 0x10, 0x10, 0x10, 0x20, 0x30, 0x38, 0x40};
static UINT32 chroma_info_motion_ctrl_128x[16] = {0x6b, 0x5f, 0x55, 0x4b, 0x41, 0x37, 0x32, 0x2d, 0x28, 0x23, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e};
static UINT32 chroma_info_map2d_weight_128x[4] = {0x0, 0x0, 0x80, 0x8};
static UINT32 chroma_info_map3D_weight_128x[4] = {0x0, 0x40, 0x80, 0xf8};
static UINT32 chroma_info_mix_th_128x[4] = {0x32, 0x3, 0x32, 0x3};
static UINT32 chroma_info_level_map_128x[16] = {0x0, 0x3, 0x7, 0xc, 0x11, 0x18, 0x20, 0x29, 0x34, 0x42, 0x51, 0x64, 0x7a, 0x95, 0xb4, 0xd9};
