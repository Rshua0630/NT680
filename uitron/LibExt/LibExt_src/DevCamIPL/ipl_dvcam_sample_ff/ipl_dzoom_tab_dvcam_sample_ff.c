/**
    IPL dzoom table dvcam_sample.

    @file       ipl_dzoom_tab_dvcam_sample_ff.c
    @ingroup    mISYSAlg
...
#include "ipl_dvcam_sample_ff_int.h"
...
UINT32 *SenMode2TblFp_dvcam_sample_ff(UINT32 id, UINT32 *DzMaxidx)
{
	UINT32 *Ptr = NULL;
	UINT32 tbl_size,i;
	ER rt = E_OK;
