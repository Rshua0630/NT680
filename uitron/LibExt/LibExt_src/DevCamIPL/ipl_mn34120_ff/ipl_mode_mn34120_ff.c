...
static IPL_EXT_LIB_TAB m_p_ipl_ext_lib = {
	IPL_GetSensorInfoFp,
	IPL_GetModeFp,
	SenMode2TblFp_mn34120_ff,
};

static IPL_SEN_MODE_SEL_INFO sensor_mode_sel_table[] = {
#if 0	//special case for manual select sensor mode
	{4634,   3488, 	IPL_UTI_CONV2_UINT32(163, 10),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_1},
	{4634,   3488, 	IPL_UTI_CONV2_UINT32(132, 10),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_2},
	{2314,   1304,	IPL_UTI_CONV2_UINT32(60, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_3},
	{2314,   1304,	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_4},
	{1572,   756,	IPL_UTI_CONV2_UINT32(120, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_5},
	{4712,   2702,	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_6},
	{4712,   3590,	IPL_UTI_CONV2_UINT32(223, 10),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_7},
	{4712,   3590,	IPL_UTI_CONV2_UINT32(223, 10),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_8},
	{2356,   1804,	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_9},
#endif
};
...
IPL_EXT_LIB_TAB *IPL_MN34120_FF_EXT_LIB_TAB(void)
{
