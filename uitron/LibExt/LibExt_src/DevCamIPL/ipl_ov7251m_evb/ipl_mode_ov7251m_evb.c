...
static IPL_EXT_LIB_TAB m_p_ipl_ext_lib = {
	IPL_GetSensorInfoFp,
	IPL_GetModeFp,
	SenMode2TblFp_ov7251m_evb,
};

static IPL_SEN_MODE_SEL_INFO sensor_mode_sel_table[] = {
//special case for manual select sensor mode
//	{640,   480, 	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_1},
};
...
IPL_EXT_LIB_TAB *IPL_OV7251M_EVB_EXT_LIB_TAB(void)
{
