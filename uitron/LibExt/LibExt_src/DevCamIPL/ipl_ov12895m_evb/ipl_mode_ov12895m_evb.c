...
static IPL_EXT_LIB_TAB m_p_ipl_ext_lib = {
	IPL_GetSensorInfoFp,
	IPL_GetModeFp,
	SenMode2TblFp_ov12895m_evb,
};

static IPL_SEN_MODE_SEL_INFO sensor_mode_sel_table[] = {
#if 1	//special case for manual select sensor mode
    {3840,   2160, 	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_2},
	{3840,   2160, 	IPL_UTI_CONV2_UINT32(25, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_2},
	{3840,   2160, 	IPL_UTI_CONV2_UINT32(24, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_2},
	{2704,   2032, 	IPL_UTI_CONV2_UINT32(60, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_3},

#if 1
    //{1920,   1080, 	IPL_UTI_CONV2_UINT32(60, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_4},
    //{1920,   1080, 	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_4},
    //{1920,   1080, 	IPL_UTI_CONV2_UINT32(25, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_4},
    //{1920,   1080, 	IPL_UTI_CONV2_UINT32(24, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_4},
#else
    ...
    {1920,   1080, 	IPL_UTI_CONV2_UINT32(25, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_2},
    {1920,   1080, 	IPL_UTI_CONV2_UINT32(24, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_2},
#endif

    {1280,    720, 	IPL_UTI_CONV2_UINT32(120, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_4},
    {1280,    720, 	IPL_UTI_CONV2_UINT32(240, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_5},
#endif
};
...
IPL_EXT_LIB_TAB *IPL_OV12895M_EVB_EXT_LIB_TAB(void)
{
