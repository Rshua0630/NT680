...
static IPL_EXT_LIB_TAB m_p_ipl_ext_lib = {
	IPL_GetSensorInfoFp,
	IPL_GetModeFp,
	SenMode2TblFp_imx117_ff,
};

static IPL_SEN_MODE_SEL_INFO sensor_mode_sel_table[] = {
#if 1	//special case for manual select sensor mode
	{2704,   2032,	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_2},
	{1920,   1080,	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_2},
	{1920,   1080,	IPL_UTI_CONV2_UINT32(60, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_11},
	{1280,   720,	IPL_UTI_CONV2_UINT32(120, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_7},
#else
	{4096,   2160, 	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_3},
	{1920,   1080,	IPL_UTI_CONV2_UINT32(60, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_4},
	{1920,   1080,	IPL_UTI_CONV2_UINT32(120, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_7},
	{1280,   960,	IPL_UTI_CONV2_UINT32(120, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_5},
	{640,    480,	IPL_UTI_CONV2_UINT32(240, 1),	SEL_SHDR_FRAME_NONE, 	SENSOR_MODE_6},
#endif
};
...
IPL_EXT_LIB_TAB *IPL_IMX117_FF_EXT_LIB_TAB(void)
{
