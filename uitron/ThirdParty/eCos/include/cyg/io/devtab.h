...
__externC Cyg_ErrNo cyg_devio_ioctl(cyg_io_handle_t handle,
                                    cyg_int32 req,
                                    cyg_uint32 arg);
...
#define CHAR_DEVIO_IOCTL_TABLE(_l,_write,_read,_select,_get_config,_set_config,_ioctl) \
cyg_devio_table_t _l = {                                        \
    _write,                                                     \
    _read,                                                      \
    cyg_devio_bwrite,                                           \
...
#define BLOCK_DEVIO_IOCTL_TABLE(_l,_bwrite,_bread,_select,_get_config,_set_config,_ioctl) \
cyg_devio_table_t _l = {                                        \
    cyg_devio_cwrite,                                           \
    cyg_devio_cread,                                            \
    _bwrite,                                                    \
...
#define DEVIO_IOCTL_TABLE(_l,_write,_read,_select,_get_config,_set_config,_ioctl) \
        CHAR_DEVIO_IOCTL_TABLE(_l,_write,_read,_select,_get_config,_set_config,_ioctl)
