            ...
            /* additional information may be included depending on the
               implementation */
                VP    istack;    /* Pointer to task stack, 
                                    ...
                                    added here for source level compatibility.  
        ...
        typedef struct t_rtsk {
            ...
            /* the following are represent extended features of support
               [level X] (implementation-dependent) */
                ...
                INT    stksz;     /* Task stack size (in bytes) */
                INT    stkused;   /* The amount of task stack used (in bytes) */
        } T_RTSK;
        ...
        typedef struct t_csem {
            ...
            /* Following is the extended function for [level X]. */
                ...
                INT   maxsem;  /* NOT SUPPORTED maximum semaphore count, 
                                  add here for source level compatibility.
                                  TODO: check how to use it */
                        // ...
            /* additional information may be included depending on the
               implementation */
