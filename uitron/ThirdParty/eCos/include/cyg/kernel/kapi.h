...
// Novatek: Provide APIs to enable / disable timeslice of specific thread -begin
#ifdef CYGSEM_KERNEL_SCHED_TIMESLICE_ENABLE

void cyg_thread_enable_timeslice(cyg_handle_t thread) __THROW;

void cyg_thread_disable_timeslice(cyg_handle_t thread) __THROW;

#endif
// Novatek: Provide APIs to enable / disable timeslice of specific thread -end
...
cyg_handle_t cyg_semaphore_queuehead( cyg_sem_t *sem ) __THROW;
cyg_handle_t cyg_semaphore_queuetail( cyg_sem_t *sem ) __THROW;
void cyg_semaphore_queuerotate( cyg_sem_t *sem ) __THROW;

cyg_handle_t cyg_semaphore_owner( cyg_sem_t *sem ) __THROW;
