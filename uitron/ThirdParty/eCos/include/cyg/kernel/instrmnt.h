...
#define CYG_INSTRUMENT_EVENT_INTR_TRIGGER       15
#define CYG_INSTRUMENT_EVENT_INTR_CHAIN_ISR     16
#define CYG_INSTRUMENT_EVENT_INTR_SET_CPU       17
#define CYG_INSTRUMENT_EVENT_INTR_GET_CPU       18
