...
externC int hal_interrupt_is_edge_trigger(int);
externC void hal_interrupt_set_level(int, int);
externC int hal_interrupt_get_level(int);
...
#define HAL_INTERRUPT_IS_EDGE_TRIGGER( _vector_)       \
    hal_interrupt_is_edge_trigger( _vector_)
#define HAL_INTERRUPT_SET_LEVEL( _vector_, _level_ )       \
    hal_interrupt_set_level( _vector_, _level_ )
#define HAL_INTERRUPT_GET_LEVEL( _vector_)       \
    hal_interrupt_get_level( _vector_)
...
externC void hal_plf_clock_installResetCB(hal_clock_reset_callback_t resetCB);
...
externC CYG_ADDRESS hal_interrupt_query_isr(int vector);
externC CYG_ADDRESS hal_interrupt_query_object(int vector);
externC CYG_ADDRESS hal_interrupt_query_epc(void);
externC int hal_interrupt_unmasked(int vector);
externC void hal_interrupt_status_dump(void);
#define HAL_INTERRUPT_QUERY_ISR(vector) hal_interrupt_query_isr((vector))
#define HAL_INTERRUPT_QUERY_OBJECT(vector) hal_interrupt_query_object((vector))
#define HAL_INTERRUPT_UNMASKED(vector) hal_interrupt_unmasked((vector))
#define HAL_INTERRUPT_STATUS_DUMP() hal_interrupt_status_dump()
//--------------------------------------------------------------------------
