...
#define ARC_X_ARM_MMU_PAGE_TABLE(abase,vbase,vprotect,vend,atable,          \
    ...
    {                                                                       \
        ...
        {                                                                   \
            ARC_ARM_MMU_SECTION(ttb_base, phys>>8, virt>>8, (cache),        \
...
#define ARC_ARM_SECTION_DEVICE                      (1 << 2)
#define ARC_ARM_SECTION_UNCACHEABLE                 (1 << 12)
#define ARC_ARM_SECTION_CACHEABLE                   ((1 << 12) | (3 << 2))
