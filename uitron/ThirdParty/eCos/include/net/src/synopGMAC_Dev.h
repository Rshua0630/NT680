...
typedef struct synopGMACDeviceStruct      
{
  ...
  void __iomem *RmiiModeCtrlReg;
	void __iomem *clock_ctrl_reg;
  void __iomem  *GpioMuxReg;
	void __iomem *rx_padin_reg;
#else
...
enum NVT_INTERNAL_PHY_Registers_D
{
	...
	NVT_PHY_REG_IREF_ENABLE = 0xfd1300C0,
	NVT_PHY_REG_TX_CUR_1 = 0xfd1300FC,
	NVT_PHY_REG_TX_CUR_2 = 0xfd130100,
	NVT_PHY_REG_ADC_VOL_CUR = 0xfd130104,
...
void synopGMAC_mac_addr_setFilter_enable(synopGMACdevice *gmacdev);
void synopGMAC_mac_addr_setFilter_disable(synopGMACdevice *gmacdev);
...
void synopGMAC_src_addr_filter_inverse(synopGMACdevice * gmacdev);
void synopGMAC_src_addr_filter_normal(synopGMACdevice * gmacdev);
...
s32 synopGMAC_mac_init(synopGMACdevice * gmacdev, u32 promisc);
...
void synopGMAC_dbg_print_rxdes_addr(synopGMACdevice *gmacdev,u32 index);
void synopGMAC_dbg_print_txdes_addr(synopGMACdevice *gmacdev,u32 index);
#endif
void synopGMAC_get_desc_data(DmaDesc * desc, u32 * Status, u32 * Buffer1, u32 * Length1, u32 * Data1, u32 * Buffer2, u32 * Length2, u32 * Data2);
#ifdef ENH_DESC_8W
s8 synopGMAC_get_tx_qptr(synopGMACdevice * gmacdev, u32 * Status, u32 * Buffer1, u32 * Length1, u32 * Data1, u32 * Buffer2, u32 * Length2, u32 * Data2, 
			  u32 * Ext_Status, u32 * Time_Stamp_High, u32 * Time_Stamp_low, u32 *now_desc);
#else
s8 synopGMAC_get_tx_qptr(synopGMACdevice * gmacdev, u32 * Status, u32 * Buffer1, u32 * Length1, u32 * Data1, u32 * Buffer2, u32 * Length2, u32 * Data2, u32 *now_desc);
#endif
s8 synopGMAC_set_tx_qptr(synopGMACdevice * gmacdev, u32 Buffer1, u32 Length1, u32 Data1, u32 Buffer2, u32 Length2, u32 Data2,u32 offload_needed, u32 *now_desc);
s8 synopGMAC_set_rx_qptr(synopGMACdevice * gmacdev, u32 Buffer1, u32 Length1, u32 Data1, u32 Buffer2, u32 Length2, u32 Data2, u32 *now_desc);
#ifdef ENH_DESC_8W
s8 synopGMAC_get_rx_qptr(synopGMACdevice * gmacdev, u32 * Status, u32 * Buffer1, u32 * Length1, u32 * Data1, u32 * Buffer2, u32 * Length2, u32 * Data2, 
                           u32 * Ext_Status, u32 * Time_Stamp_High, u32 * Time_Stamp_low, u32 *now_desc);
#else
s8 synopGMAC_get_rx_qptr(synopGMACdevice * gmacdev, u32 * Status, u32 * Buffer1, u32 * Length1, u32 * Data1, u32 * Buffer2, u32 * Length2, u32 * Data2, u32 *now_desc);
#endif
...
u32 synopGMAC_get_dma_current_TX_desc(synopGMACdevice * gmacdev);
u32 synopGMAC_get_dma_current_RX_desc(synopGMACdevice * gmacdev);
...
u32 synopGMAC_get_phy_id(synopGMACdevice * gmacdev);
void synopGMAC_restart_auto_nego(synopGMACdevice * gmacdev);
#ifdef CONFIG_NVT_RTL_PHY_SUPPORT
/* For 8201 EL */ 
s32 synopGMAC_get_phy_test_reg(synopGMACdevice * gmacdev);
s32 synopGMAC_get_phy_rxer_reg(synopGMACdevice * gmacdev);
void synopGMAC_get_phy_LBREM_reg(synopGMACdevice * gmacdev);

u16 synopGMAC_get_phy_ctrl_reg(synopGMACdevice * gmacdev);
s32 synopGMAC_set_phy_page_reg(synopGMACdevice * gmacdev,u8 page);

/* For 8201 F */
u16 synopGMAC_RTL8201F_get_phy_RMII_mode_setting_reg(synopGMACdevice * gmacdev);
s32 synopGMAC_RTL8201F_set_phy_TXC_direction(synopGMACdevice *gmacdev, u8 input);
s32 synopGMAC_RTL8201F_set_phy_CRS_RXDV_pin(synopGMACdevice *gmacdev, u8 pin_CRS);
u16 synopGMAC_RTL8201F_get_phy_fibermode_loopback_reg(synopGMACdevice * gmacdev);
u16 synopGMAC_RTL8201F_get_phy_interrupt_status(synopGMACdevice * gmacdev);
s32 synopGMAC_RTL8201F_set_phy_adjust_RMII_TX_timing(synopGMACdevice *gmacdev, u8 timing);
s32 synopGMAC_RTL8201F_set_phy_adjust_RMII_RX_timing(synopGMACdevice *gmacdev, u8 timing);
#endif

s32 synopGMAC_set_phy_speed(synopGMACdevice * gmacdev, u8 speed10);
