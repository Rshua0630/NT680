...
#define DMISGR2_MDMA_WAKEUPVBUS	(1 << 17)
#define DMISGR2_MDMA_IDLE	(1 << 16)
#define DMISGR2_MDMA_CMPLT	(1 << 7)
#define DMISGR2_MDMA_CMPLT2	(1 << 8)
#define DMISGR2_MDMA_CMPLT3	(1 << 9)
#define DMISGR2_MDMA_CMPLT4	(1 << 10)
#define DMISGR2_MDMA_CMPLT5	(1 << 11)
#define DMISGR2_MDMA_CMPLT6	(1 << 12)
#define DMISGR2_MDMA_CMPLT7	(1 << 13)
#define DMISGR2_MDMA_CMPLT8	(1 << 14)
#define DMISGR2_MDMA_CMPLTALL	(0xFF << 7)
...
#define DISGR2_DMA_CMPLT8	(1 << 14)
#define DISGR2_DMA_CMPLT7	(1 << 13)
#define DISGR2_DMA_CMPLT6	(1 << 12)
#define DISGR2_DMA_CMPLT5	(1 << 11)
#define DISGR2_DMA_CMPLT4	(1 << 10)
#define DISGR2_DMA_CMPLT3	(1 << 9)
#define DISGR2_DMA_CMPLT2	(1 << 8)
...
/* (0x1C4) */
#define DMACPSR1_DMA_ABORT	(0x3 << 2)
...
#define FOTG210_DMACHOFS(epnum)		(0x200 + ((((epnum)-1)<<1)<<3))
#define FOTG210_DMAADROFS(epnum)	(0x204 + ((((epnum)-1)<<1)<<3))
...
struct fotg200_udc {
	...
	struct fotg200_ep			*ep[FOTG210_MAX_NUM_EP];
...
#define gadget_to_fotg200(g)	container_of((g), struct fotg200_udc, gadget)
