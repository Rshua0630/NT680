...
static void phy_error(struct phy_device *phydev)
{
	...
	phy_trigger_machine(phydev);   // patch from kernel 4.8.8
}
...
out_unlock:
	 ...
	 */
    phy_trigger_machine(phydev);  // patch for timing issue
}
