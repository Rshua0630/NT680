...
static int ramoops_probe(struct platform_device *pdev)
{
	...
	ramoops_console_size = record_size;
        pdata->console_size = ramoops_console_size;
	ramoops_ftrace_size = 0;
	ramoops_pmsg_size = 0;
        ...
        pdata->ecc_info.block_size = ramoops_ecc == 1 ? 16 : ramoops_ecc;
	memset(&(pdata->ecc_info), 0, sizeof(pdata->ecc_info));
...
static void ramoops_register_dummy(void)
{
	...
	dummy_data->ecc_info.block_size = ramoops_ecc == 1 ? 16 : ramoops_ecc;
	memset(&(dummy_data->ecc_info), 0, sizeof(dummy_data->ecc_info));
