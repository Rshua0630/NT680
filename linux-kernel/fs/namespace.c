...
#if defined(CONFIG_DM_NFSB)
extern int nvt_dm_check_nfsb(struct nfsb_header *hdr, const char* dev_path);
extern int nvt_dm_setup_linear(struct nfsb_header *hdr, dev_t *dev);
extern int nvt_dm_setup_nfsb(struct nfsb_header *hdr, dev_t *dev, const char* dir_name, char* mapper_path);
#endif 	
/*
