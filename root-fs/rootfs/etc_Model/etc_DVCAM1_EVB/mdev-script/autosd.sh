...
ugxstrg_init()
{
	...
	if [ "$NVT_ITRON_DRIVE_A" == "NVT_ITRON_DRIVE_EMMC_1" ]; then
		...
		DRIVE_A=${SD2_DIR};
	elif [ "$NVT_ITRON_DRIVE_A" == "NVT_ITRON_DRIVE_SD_3" ]; then
		DRIVE_A=${SD3_DIR};		
	...
	if [ "$NVT_ITRON_DRIVE_B" == "NVT_ITRON_DRIVE_EMMC_1" ]; then
		...
		DRIVE_B=${SD2_DIR};
	elif [ "$NVT_ITRON_DRIVE_B" == "NVT_ITRON_DRIVE_SD_3" ]; then
		DRIVE_B=${SD3_DIR};	
	...
	if [ "$NVT_ITRON_DRIVE_C" == "NVT_ITRON_DRIVE_EMMC_1" ]; then
		...
		DRIVE_C=${SD2_DIR};
	elif [ "$NVT_ITRON_DRIVE_C" == "NVT_ITRON_DRIVE_SD_3" ]; then
		DRIVE_C=${SD3_DIR};		
	...
	if [ "$NVT_ITRON_DRIVE_D" == "NVT_ITRON_DRIVE_EMMC_1" ]; then
		...
		DRIVE_D=${SD2_DIR};
	elif [ "$NVT_ITRON_DRIVE_D" == "NVT_ITRON_DRIVE_SD_3" ]; then
		DRIVE_D=${SD3_DIR};		
